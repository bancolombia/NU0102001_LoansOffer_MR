...
public class MapTimeOfferAdapterTest {
    ...
    public void init() throws IOException {
        ...
        attributes.add(Attribute.builder().name("CodigoProductoLI")
                .value("14").build());
        RuleRequest request = RuleRequest.builder()
                .attributes(attributes)
                .productCode("14")
                .ruleName("ReglaPermanenciaOfertaLI")
                .build();
        ...
        Mono<RuleResponse> responseMono = adapter.getTimeOffer();
    }
