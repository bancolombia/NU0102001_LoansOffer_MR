...
import co.com.bancolombia.libreinversion.model.customer.rest.ResponseCustomerBasicData;
...
public class CustomerAdapterTest {
    ...
    private ResponseCustomerBasic response;
    private ObjectMapper mapper;
    private Mono<ResponseCustomerBasic> responseMono;
    ...
    public void init() throws IOException {
        ...
        response = ResponseCustomerBasic.builder()
                .data(ResponseCustomerBasicData.builder()
                        .role("ROLNEG_02")
                        .build()).build();

        mapper = new ObjectMapper();
        String messageId = "cf6f7b7c-5d94-4f8a-afc4-6b796da4bfbc";
        responseMono = adapter.callPersonalData(request, messageId, 20L);
    }
