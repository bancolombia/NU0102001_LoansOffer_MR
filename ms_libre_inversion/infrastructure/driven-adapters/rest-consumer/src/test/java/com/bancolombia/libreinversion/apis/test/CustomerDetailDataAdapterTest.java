...
public class CustomerDetailDataAdapterTest {

    private MockWebServer mockWebServer;
    private ResponseCustomerDetail response;
    private ObjectMapper mapper;
    private Mono<ResponseCustomerDetail> responseMono;
    ...
    public void init() throws IOException {
        ...
        response = ResponseCustomerDetail.builder()
                .data(ResponseCustomerDetailData.builder().codeCIIU("CIUDAD_08001003").build())
                .build();

        mapper = new ObjectMapper();
        String messageId = "cf6f7b7c-5d94-4f8a-afc4-6b796da4bfbc";
        responseMono = adapter.callDetailInformation(request, messageId, 20L);
    }
